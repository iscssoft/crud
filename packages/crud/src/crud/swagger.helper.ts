...
import { RequestQueryBuilder } from '@iscssoft/crud-request';
import { isString, objKeys } from '@iscssoft/util';
...
export class Swagger {
  ...
  static createQueryParamsMeta(name: BaseRouteName, options: MergedCrudOptions) {
    ...
    const docsLink = (a: string) =>
      `<a href="https://github.com/iscssoft/crud/wiki/Requests#${a}" target="_blank">Docs</a>`;
